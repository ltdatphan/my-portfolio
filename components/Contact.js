    ...
    <>
      <SectionTemplate title="Contact" hash="contact">
        ...
        <div className={styles.socialLinks}>
          <a href="https://www.linkedin.com/in/ltdatphan/" target="_blank">
            <Image src="/linkedin.png" height="64px" width="64px"></Image>
          </a>
          <a href="https://github.com/ltdatphan" target="_blank">
            <Image src="/github.png" height="64px" width="64px"></Image>
          </a>
          <a href="mailto:lethanhdat.phan@ryerson.ca" target="_blank">

...
import { IProject } from '@/sanity/lib/interfaces'

const QUERY = `*[_type == "project"]{_id, name, desc, url, content, tags, date, "imageUrl": image.asset->url} | order(date desc)`

export default async function ProjectsDynamic() {
    const projects = await sanityFetch<IProject[]>({ query: QUERY })
                    ...
                    <li className={`mb-16`} key={index}>
                        ...
                        >
                            ...
                            <div className="md:col-span-6 z-10">
                                ...
                                >
                                    {project.tags.map((tag: string, i: Key) => (
                                        <li
                                            key={i}
